...
This repository contains a comprehensive sales performance analysis done on a data set for a retail store. I have utilized Excel, SQL and Power BI data analytics tools to uncover trends, patterns and correlations that drive towards actionable insights and data driven business decisions.
...
### OVERVIEW
---
This project analyzes sales data of 50,000 sales record for a retail shop. This is to uncover key insights such as top-selling products, regional performance, and monthly sales trends. 
